...
if (isset($_POST['add_service'])) {
    ...
    executeQuery($conn, $sql, ['s', $service_name]);
}

if (isset($_POST['delete_service'])) {
    $service_id = $_POST['service_id'];
    $sql = "DELETE FROM services WHERE id = ?";
    executeQuery($conn, $sql, ['i', $service_id]);
}

if (isset($_POST['add_animal'])) {
    $animal_name = $_POST['animal_name'];
    $species = $_POST['species'];
    $sql = "INSERT INTO animals (name, species) VALUES (?, ?)";
    executeQuery($conn, $sql, ['ss', $animal_name, $species]);
}

if (isset($_POST['delete_animal'])) {
    $animal_id = $_POST['animal_id'];
    $sql = "DELETE FROM animals WHERE id = ?";
    executeQuery($conn, $sql, ['i', $animal_id]);
}
?>
